...
class NetConstructor:
    """ Class to construct networks. Takes as input the function name (e.g. PDCNet_vgg16), the name of the module
    which contains the network function (e.g. models.PDCNet) and the arguments for the network
    ...
    def __init__(self, fun_name, fun_module, args, kwds):
        ...
        self.args = args
        self.kwds = kwds  # arguments which were actually given to the function
